...
import { createLostBikeReport } from "@/lib/actions";
import { FormState } from "@/lib/validation";

export default function ReportLostBikePage() {
  const [state, formAction] = useFormState(createLostBikeReport, { success: false });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="card p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-8">Ilmoita kadonnut pyörä</h1>
          ...
          <form action={formAction} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label htmlFor="lostDate" className="form-label">Kadonnut päivämäärä</label>
                <input
                  type="date"
                  id="lostDate"
                  name="lostDate"
              ...
              <div>
                <label htmlFor="place" className="form-label">Paikka</label>
                <input
                  type="text"
                  id="place"
                  name="place"
            ...
            <div>
              <label htmlFor="contact" className="form-label">Yhteystiedot (sähköposti/puhelin)</label>
              <input
                type="text"
                id="contact"
                name="contact"
